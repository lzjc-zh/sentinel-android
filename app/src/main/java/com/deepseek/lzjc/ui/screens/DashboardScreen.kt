        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Row(
                ...
                Surface(
                    ...
                    Text(
                        text = if (plan.status == "Running") "��Ч��" else plan.status,
                        modifier = Modifier.padding(horizontal = 8.dp, vertical = 2.dp),
                        color = Color.White,
                        style = MaterialTheme.typography.labelSmall
                    )
            ...
            Row(
                ...
                ArkInfoItem("5Сʱ", "${plan.afp5hUsed.toLong()}/${plan.afp5hQuota.toLong()}")
                ArkInfoItem("����", "${plan.afp1wUsed.toLong()}/${plan.afp1wQuota.toLong()}")
                ArkInfoItem("����", "${plan.afp1mUsed.toLong()}/${plan.afp1mQuota.toLong()}")
            }
            Spacer(Modifier.height(12.dp))
            ...
            Spacer(Modifier.height(4.dp))
            Text(
                text = "����: ${plan.endTime.substringBefore("T")} | �Զ�����: ${if (plan.autoRenew) "��" else "��"}",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.appColors.textTertiary
            )
        }
